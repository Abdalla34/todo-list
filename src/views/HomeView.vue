<template>
  <div class="home">
    <div class="display d-flex justify-content-center align-items-center gap-4">
      <div class="icon">
        <svg
          width="22"
          height="36"
    ...
    <div class="container text-center">
      ...
      <div class="row d-flex justify-content-center mt-5">
        <div class="col-lg-9 col-md-9 col-sm-12 d-flex justify-content-between">
          <div class="d-flex gap-2">
            <h6 class="color-text">Created</h6>
            <div class="text-white create">{{ totalCreated }}</div>
          </div>
          <div class="d-flex gap-2">
